...
const FILES_TO_CACHE = [
  '/Salaus/',
  '/Salaus/index.html?v=3.0',
  '/Salaus/style.css?v=3.0',
  '/Salaus/salaus.js?v=3.0',
  '/Salaus/app.js?v=3.0',
  ...
  '/Salaus/cookie-privacy.html?v=3.0',
  '/Salaus/info.html?v=3.0',
  '/Salaus/informazioni.html?v=3.0',
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate') {
    e.respondWith(
      fetch(e.request).catch(() => caches.match('/Salaus/index.html?v=3.0'))
    );
  } else {
    e.respondWith(
