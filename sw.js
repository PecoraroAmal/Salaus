...
const FILES_TO_CACHE = [
  '/Salaus/',
  '/Salaus/index.html?v=2.1',
  '/Salaus/style.css?v=2.1',
  '/Salaus/salaus.js?v=2.1',
  '/Salaus/app.js?v=2.1',
  ...
  '/Salaus/cookie-privacy.html?v=2.1',
  '/Salaus/info.html?v=2.1',
  '/Salaus/informazioni.html?v=2.1',
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate') {
    e.respondWith(
      fetch(e.request).catch(() => caches.match('/Salaus/index.html?v=2.1'))
    );
  } else {
    e.respondWith(
