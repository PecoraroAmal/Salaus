...
const FILES_TO_CACHE = [
  '/Salaus/',
  '/Salaus/index.html?v=4.3',
  '/Salaus/style.css?v=4.3',
  '/Salaus/salaus.js?v=4.3',
  '/Salaus/app.js?v=4.3',
  ...
  '/Salaus/cookie-privacy.html?v=4.3',
  '/Salaus/info.html?v=4.3',
  '/Salaus/informazioni.html?v=4.3',
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate') {
    e.respondWith(
      fetch(e.request).catch(() => caches.match('/Salaus/index.html?v=4.3'))
    );
  } else {
    e.respondWith(
